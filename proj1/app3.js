...
var luisAppUrl = process.env.LUIS_APP_URL || 'https://westus.api.cognitive.microsoft.com/luis/v2.0/apps/a1ed4bfb-3752-4cf2-b52d-3ad3d4318d41?subscription-key=4bd3b5cc82cc4835ac5e1d3c343b600c&verbose=true&timezoneOffset=0&q=';
bot.recognizer(new builder.LuisRecognizer(luisAppUrl));

bot.dialog('/internetIssue', [
    function (session) {
    builder.Prompts.choice(session,"Select the problem you are facing","Cannot Connect-Surf|Slow Speeds|Intermittent Connectivity|Wifi Issues|Static IP issues|Gateway Configuration|Informational",{ listStyle: builder.ListStyle.button });
    },
